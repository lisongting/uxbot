 ...
 * 
 */
package cn.iscas.xlab.uxbot.ros.rosbridge;

import java.lang.reflect.Field;

import cn.iscas.xlab.uxbot.ros.ROSClient;
import cn.iscas.xlab.uxbot.ros.Service;
import cn.iscas.xlab.uxbot.ros.message.Empty;
import cn.iscas.xlab.uxbot.ros.message.Message;
import cn.iscas.xlab.uxbot.ros.message.MessageType;
import cn.iscas.xlab.uxbot.ros.rosapi.message.MessageDetails;
import cn.iscas.xlab.uxbot.ros.rosapi.message.Nodes;
import cn.iscas.xlab.uxbot.ros.rosapi.message.Services;
import cn.iscas.xlab.uxbot.ros.rosapi.message.Topic;
import cn.iscas.xlab.uxbot.ros.rosapi.message.Topics;
import cn.iscas.xlab.uxbot.ros.rosapi.message.Type;
import cn.iscas.xlab.uxbot.ros.rosapi.message.TypeDef;
import cn.iscas.xlab.uxbot.ros.rosbridge.implementation.ROSBridgeWebSocketClient;
import cn.iscas.xlab.uxbot.ros.rosbridge.operation.Operation;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<cn.iscas.xlab.uxbot.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<cn.iscas.xlab.uxbot.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        cn.iscas.xlab.uxbot.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new cn.iscas.xlab.uxbot.ros.rosapi.message.Service(service)).type;
    }
